...
export default function OvalCarousel({
  ...
  return (
    <div className="flex items-center justify-center py-12 select-none">
      <div style={wrapperStyle} className="relative rounded-full" aria-hidden="true">
        ...
        >
          {logos.map((logo, index) => (
            <div
              ...
              className="absolute flex h-18 w-16 flex-col items-center justify-center rounded-full bg-white/5 backdrop-blur-sm"
              style={{
                left: 0,
                top: 0,
            ...
            >
              ...
              <span
                className="mt-1 text-xs text-gray-300 select-none"
                style={{ pointerEvents: 'none' }}
              >
                {logo.name}
              </span>
